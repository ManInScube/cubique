...
gulp.task('sprite', gulp.series('spriteClean'), function() {
...
gulp.task('svgSprite', gulp.series('removeSvg'), function() {
...
gulp.task('watch', function() {
    ...
    gulp.watch('app/static/icons/*.svg', gulp.series('svgSprite'));
